            ...
            <div className="relative h-64 overflow-hidden rounded-t-2xl">
              ...
              <div className="absolute bottom-4 left-4 right-4">
                <div className="flex items-center justify-between">
                  <Badge className="bg-white/90 text-gray-900 border-0 shadow-sm">{project.category}</Badge>
            ...
            <div className="p-8">
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-8">
                <Card className="border-0 bg-purple-50">
                  <CardContent className="p-6 text-center">
                    ...
                    <h3 className="font-semibold text-gray-900 mb-1">{language === "it" ? "Durata" : "Timeline"}</h3>
                    <p className="text-purple-600 font-bold">{project.timeline}</p>
                  </CardContent>
                </Card>
                ...
                <Card className="border-0 bg-green-50">
                  <CardContent className="p-6 text-center">
                    ...
                    <h3 className="font-semibold text-gray-900 mb-1">ROI</h3>
                    <p className="text-green-600 font-bold">{project.roi}</p>
                  </CardContent>
                </Card>
                ...
                <Card className="border-0 bg-blue-50">
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-blue-600 font-bold">{project.investment}</p>
                  </CardContent>
                </Card>
              </div>
              ...
              <div className="mb-8">
                ...
                <div className="flex flex-wrap gap-3">
                  {project.technologies.map((tech: string, index: number) => (
                    ...
                    >
                      <Badge variant="outline" className="border-gray-300 text-gray-700 bg-white px-4 py-2">
                        {tech}
                      </Badge>
                    </motion.div>
                  ))}
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button
                  size="lg"
                  variant="outline"
                  className="border-2 border-gray-300 text-gray-700 hover:bg-gray-50 flex-1 bg-transparent"
                  onClick={onClose}
                >
